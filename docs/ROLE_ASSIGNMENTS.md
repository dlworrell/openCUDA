...
| 3 | Task Manager / Triage Coordinator | L2 | Triage | Allows issue assignment/classification without code-write authority. |
| 4 | Hardware Validation Maintainer | L4 | Maintain or Write with scoped policy | Independent validation of DL380p/CUBIX/K80 measurements. |
| 5 | CI/Build Maintainer | L4 | Maintain | Maintains build/CI without full admin authority. |
| 6 | Architecture Approver | L5 | Maintain or Write plus explicit domain delegation | Protects ABI and component boundaries. |
| 7 | Compatibility Approver | L5 | Maintain or Write plus explicit domain delegation | Protects support/lowering/fallback truthfulness. |
| 8 | Security Reviewer | L5 | Maintain; security-management permissions as needed | Separates security approval from ordinary development. |
| 9 | Release Manager | L5 | Maintain | Separates release authority from general code contribution. |
| 10 | Repository Administrator | L6 | Admin | Limit destructive/sensitive controls to very few users. |
...
Role grants, changes, suspensions, and revocations must be committed through a pull request so the repository history records who changed authority and why. L5+ authority changes require Project Owner approval. L6/L7 changes require explicit Project Owner approval and must not be self-delegated by a lower-level administrator.
